...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    private final InstanceIdOutboundInterceptor instanceIdOutboundInterceptor;

    public WebSocketConfig(JwtChannelInterceptor jwtChannelInterceptor,
                            InstanceIdOutboundInterceptor instanceIdOutboundInterceptor) {
        this.jwtChannelInterceptor = jwtChannelInterceptor;
        this.instanceIdOutboundInterceptor = instanceIdOutboundInterceptor;
    }
    ...
    public void configureClientOutboundChannel(ChannelRegistration registration) {
        registration.interceptors(instanceIdOutboundInterceptor);
    }
}
